...
document.addEventListener('DOMContentLoaded', () => {
  ...
  startRepairTick();
  postMessage("Game starting... May the clone god be with you!"); //Prints a message to the viewer.
});
...
// checks for end game state, if currentFactoryDamageValue is greater or equal to 2k. 
...
function resetGame(){
    ...
    repairTick = null;
    totalManualActions = null;
    aCurrentFactoryDamage = null;
    currentMessage = null;
    prevMessage = null;
    const displayedFactoryDamagePoints = document.getElementById("factoryDamagePoints");
    const displayedCoreHitPoints = document.getElementById('coreHitPoints')
    ...
    displayedCoreHitPoints.dataset.points = 0;
